...
metrics <- tibble("priority_area" = c(rep("Conditions for Learning",5),rep("Pupil Outcomes",8), rep("Engagement",10) ) ,
                  ...
                  "source" = c(rep("Local Dashboard Data",1),
                               ...
                               "student information systems", #5
                               rep("Dashboard",2),
                               "Dashboard",
                               "Dashboard",
                               "Dataquest",# https://www.cde.ca.gov/ci/gs/hs/eapindex.asp  doesn't exist, maybe in CCI? #10
                               "Dashboard",
                               "CAASPP results",
                               "Local data",
                               "Local Dashboard Data and district and school surveys related to WASC and Single Plan Student Achievement, or DLAC/ELAC",
                               "Local Dashboard Data and local data on parent involvement in district/school activities (e.g., committees, student clubs, after school enrichment, fundraisers, carnivals, promotion activities, PTO membership)",#15
                  ...
                  "description" = c("Teachers: Fully Credentialed & Appropriately Assigned", 
                                    ...
                                    "Students have access and are enrolled in a broad course of study (Social Science, Health, VAPA, Science, PE, World Language)", #5
                                    ...
                                    "Parental Participation in programs for Unduplicated Pupils (UPs)", #15
                                    "Attendance rates", 
                  ...
                  "notes" = c( "Please note this only looks at teachers and not adminstrators, pupil services, itinerant nor push-in/pull-out teachers. The most recent available public data is 2018-19. It is grouped at the district level, and is weighted by percent FTE.  It does not yet look at proper assignment of teachers, only credential status. Please also reference your Williams Report."  ,
                               ...
                               "Note 2019-20 data is available on the Dashboard. Please note this is the best possible calculation, but will be slightly inflated for students that completed A-G and also complete a CTE pathway. It is not possible to get the exact figure with the aggregate data available.  CALPADS Report 3.14, 3.15 and 15.1 may be helpful.", # just use the CCI indicator too. 
