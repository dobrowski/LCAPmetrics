...
Please note that the most recently available data is used, but it many cases because of COVID-19 and the de facto suspension of the state dashboard, the data represented comes from the 2019 dashboard representing the 2018-19 school year. MCOE and CDE encourage you to use current local data from this school year when available.  
