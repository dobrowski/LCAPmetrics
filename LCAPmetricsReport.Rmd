...
As part of this response, the LEA must identify all schools, student groups and student groups at schools which are at the lowest performance level, which will remain unchanged during the three-year LCAP cycle. 
...
Note these are listed above in the Annual Performance section. 


Insert cluster graphing???
