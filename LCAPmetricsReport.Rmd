...
---
title: `r metrics_dist[18,2]` LCAP Metrics Report
---
...
Please remember that starting this year, local dashboard indicators for the 2020 Dashboard need to be presented at a regularly scheduled board meeting as a *non-consent* item in conjunction with the adoption of the LCAP.  
...
undup.words <- glue( "The percentage of unduplicated students for 2018-19 was { scales::percent( undup$undup.perc , accuracy = .1 ) }." )
